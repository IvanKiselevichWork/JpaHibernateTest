CREATE DATABASE  IF NOT EXISTS `university_hib` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `university_hib`;
-- MySQL dump 10.13  Distrib 8.0.18, for Win64 (x86_64)
--
-- Host: localhost    Database: university_hib
-- ------------------------------------------------------
...
-- Dump completed on 2020-05-13 22:23:26
